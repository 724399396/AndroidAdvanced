...
public class MyCanvasView extends View {
    ...
    public MyCanvasView(Context context, @Nullable AttributeSet attrs) {
        ...
        // Smoothes out edge of what is drawn without affecting shape
        mPaint.setAntiAlias(true);
        // Dithering affects how colors with higher-precision devices
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // Invalidate() is inside the case statement because there are many
